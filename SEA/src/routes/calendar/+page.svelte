...
<script src="https://cdn.jsdelivr.net/npm/@event-calendar/build@2.6.1/event-calendar.min.js" type="text/javascript">
...
{/if}
  ...
  <header class="row">
    <h4 class="col"><a href="https://github.com/vkurko/calendar">Event Calendar</a> Demo</h4>
        ...
        <button id="authorize_button" on:click={handleSignoutClick}> Sign Out</button>
    </header>
    <main class="row">
